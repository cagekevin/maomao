...
export const API_BASE =
  import.meta.env?.VITE_API_BASE?.replace(/\/+$/, '') || `http://127.0.0.1:${LOCAL_TOOL_PORT}`;
...
export const AGENT_CONTEXT_WINDOW_DEFAULT =
  Number(import.meta.env?.VITE_AGENT_CONTEXT_WINDOW) || 128_000;
