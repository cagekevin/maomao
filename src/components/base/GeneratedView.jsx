...
import { useAssetDragToCanvas, fetchText, textCache } from './useAssetDragToCanvas.js'
...
function GeneratedView() {
  ...
  // 拖到画布建节点：统一走 useAssetDragToCanvas（图片/视频/音频 → imageNode，文字 → textNode），经「点开大图预览」拖
