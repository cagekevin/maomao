...
export function resolveSystem(playbookId, key) {
...
export function resolveImageGenSys(playbookId, type, defaultType = 'keyframe') {
  const pb = getPlaybook(playbookId)
