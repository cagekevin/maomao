 ...
 */
export function resolveMediaType(url: string | undefined | null, mediaType: ResultKind | undefined | null): ResultKind {
 ...
 */
export function extractResultUrl({ data, json, type = 'image' }: { data?: unknown; json?: unknown; type?: ResultKind }): string | undefined {
