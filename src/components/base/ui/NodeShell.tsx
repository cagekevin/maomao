 ...
 * 参考节点（从简到繁）：TextGenerate / ImageGenerate → ImageBoxNode / GridSplitNode → ScriptBoxNode（复合）。
 *
 * ── 0. 标准节点骨架（照抄）──
 *   return (
 ...
 *   统一范式（TextGenerate/ImageGenerate/DiscountVideo/GridSplit/GridMerge 全部一致）：
