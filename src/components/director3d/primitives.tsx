  ...
  return (
    <mesh position={[0, 0, -0.18]} castShadow receiveShadow>
      ...
      <meshStandardMaterial
        color={color}
        {...whiteMaterial}
        {...(selected ? selectedEmission : null)}
      />
    </mesh>
  );
}
    ...
    <group>
      {Array.from({ length: steps }, (_, index) => {
        ...
        return (
          <group
            key={index}
            position={[0, -0.5 + height / 2, -0.5 + (index + 0.5) / steps]}
            scale={[1, height, 1 / steps]}
          >
            <SimplePart color={color} selected={selected} />
          </group>
        );
      })}
    </group>
...
function TableModel({ color, selected = false }) {
  return (
    <group>
      ...
      {[-0.41, 0.41].flatMap((x) =>
        [-0.31, 0.31].map((z) => (
          <group key={`${x}-${z}`} position={[x, -0.08, z]} scale={[0.1, 0.72, 0.1]}>
            <SimplePart color={color} selected={selected} />
          </group>
        )),
      )}
...
function ChairModel({ color, selected = false }) {
  return (
    <group>
      ...
      <group position={[0, 0.3, 0.34]} scale={[0.82, 0.58, 0.12]}>
        <SimplePart color={color} selected={selected} />
      </group>
      {[-0.32, 0.32].flatMap((x) =>
        [-0.29, 0.29].map((z) => (
          <group key={`${x}-${z}`} position={[x, -0.27, z]} scale={[0.09, 0.48, 0.09]}>
            <SimplePart color={color} selected={selected} />
          </group>
        )),
      )}
...
function SofaModel({ color, selected = false }) {
  return (
    <group>
      ...
      <group position={[0, 0.22, 0.32]} rotation={[-0.12, 0, 0]} scale={[1, 0.62, 0.18]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group position={[-0.45, 0.08, 0]} scale={[0.12, 0.38, 0.82]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group position={[0.45, 0.08, 0]} scale={[0.12, 0.38, 0.82]}>
        <SimplePart color={color} selected={selected} />
...
function DoorModel({ color, selected = false }) {
  return (
    <group>
      ...
      <group position={[0, 0.46, 0]} scale={[0.92, 0.09, 0.16]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group position={[0, -0.02, 0]} scale={[0.78, 0.86, 0.07]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group position={[0.27, -0.02, -0.07]} scale={[0.045, 0.045, 0.045]}>
        <SimplePart shape="sphere" color="#625c50" />
      </group>
    </group>
  );
}
...
function WindowModel({ color, selected = false }) {
  return (
    <group>
      ...
      <group position={[0, 0.46, 0]} scale={[1, 0.08, 0.14]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group position={[0, -0.46, 0]} scale={[1, 0.08, 0.14]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group scale={[0.06, 0.86, 0.08]}>
        <SimplePart color={color} selected={selected} />
      </group>
      <group scale={[0.86, 0.06, 0.08]}>
        <SimplePart color={color} selected={selected} />
      </group>
    </group>
  );
  ...
  return (
    <group>
      <group position={[0, -0.23, 0]} scale={[0.2, 0.55, 0.2]}>
        <SimplePart shape="cylinder" color="#766b57" />
      </group>
      <group position={[0, 0.2, 0]} scale={[0.78, 0.65, 0.78]}>
        <SimplePart shape="sphere" color={color} selected={selected} />
      </group>
      <group position={[-0.25, 0.04, 0.08]} scale={[0.48, 0.45, 0.48]}>
        <SimplePart shape="sphere" color={color} selected={selected} />
      </group>
      <group position={[0.25, 0.03, -0.08]} scale={[0.48, 0.43, 0.48]}>
        <SimplePart shape="sphere" color={color} selected={selected} />
      </group>
    </group>
  );
...
function VehicleModel({ color, selected = false }) {
  return (
    <group>
      ...
      <group position={[0.08, 0.22, -0.03]} scale={[0.52, 0.34, 0.66]}>
        <SimplePart color={color} selected={selected} />
      </group>
      {[-0.34, 0.34].flatMap((x) =>
        [-0.32, 0.32].map((z) => (
          ...
          >
            <SimplePart shape="cylinder" color="#343432" />
          </group>
        )),
      )}
    </group>
...
function PrimitiveModel({ type, color, selected, parts = [] }) {
  ...
  if (type === 'assembly' && parts.length)
    return <AssemblyModel parts={parts} color={color} selected={selected} />;
