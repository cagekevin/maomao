...
type KindNotCovered<T extends string, A extends ReadonlySet<string>, B extends ReadonlySet<string>> =
 ...
 */
export function isRenderableTrack(kind: TrackKind): kind is SetMember<typeof RENDERABLE_TRACK_KINDS> {
