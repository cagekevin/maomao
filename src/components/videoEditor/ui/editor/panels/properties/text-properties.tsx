...
import { MIN_FONT_SIZE, MAX_FONT_SIZE } from '@videoEditor/constants/text-constants';
                          ...
                          <Slider
                            ...
                            onValueChange={([value]) => {
                              if (initialBgOpacityRef.current === null) {
                                initialBgOpacityRef.current = element.backgroundOpacity ?? 1;
                              }
                              editor.timeline.updateElements({
                                updates: buildBatchUpdates({
                          ...
                          <Slider
                            ...
                            onValueChange={([value]) => {
                              if (initialBgPaddingYRef.current === null) {
                                initialBgPaddingYRef.current = element.backgroundPaddingY ?? 4;
                              }
                              editor.timeline.updateElements({
                                updates: buildBatchUpdates({
                          ...
                          <Slider
                            ...
                            onValueChange={([value]) => {
                              if (initialBgPaddingXRef.current === null) {
                                initialBgPaddingXRef.current = element.backgroundPaddingX ?? 8;
                              }
                              editor.timeline.updateElements({
                                updates: buildBatchUpdates({
