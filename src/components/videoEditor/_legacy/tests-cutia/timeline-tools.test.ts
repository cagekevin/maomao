...
import type { CreateTimelineElement, VideoTrack } from '@videoEditor/types/timeline';
...
const { addVideoToTimelineTool, getTimelineStateTool } = await import('./timeline-tools');
