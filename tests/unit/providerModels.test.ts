...
} from '../../src/components/base/utils/providerModels.ts';

const providers = [
  {
    id: 'lovart',
    name: 'Lovart',
    image_models: [{ id: 'model-a', label: '模型A' }],
    chat_models: [{ id: 'chat-1', label: '对话1' }],
    video_models: [],
  },
  {
    id: 'modelscope',
    name: '魔搭',
    image_models: [{ id: 'Qwen/Qwen3-14B', label: '通义' }],
    chat_models: [],
    video_models: [{ id: 'v1', label: '视频1' }],
  },
];
