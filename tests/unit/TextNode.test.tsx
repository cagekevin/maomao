...
vi.mock('../../src/components/base/prompt/PromptLibraryButton.tsx', () => ({ default: mocks.PromptLibraryButton }))
...
vi.mock('../../src/components/base/api/generate.ts', () => ({ chatCompletions: mocks.chatCompletions }))
