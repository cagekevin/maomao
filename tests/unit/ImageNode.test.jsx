...
vi.mock('../../src/components/base/useFitNodeRatio.ts', () => ({ useFitNodeRatio: mocks.useFitNodeRatio }))
vi.mock('../../src/components/base/useVideoPoster.ts', () => ({ useVideoPoster: mocks.useVideoPoster }))
