...
vi.mock('../../src/components/base/core/contentStore.ts', () => ({ contentSet: (...a: unknown[]) => (h.contentSet as unknown as (...x: unknown[]) => void)(...a) }))
vi.mock('../../src/components/base/utils/clipboard.ts', () => ({ downloadUrl: (...a) => h.downloadUrl(...a) }))
vi.mock('../../src/components/base/core/logger.ts', () => ({ logger: h.logger }))
vi.mock('../../src/components/base/utils/previewUrl.ts', () => ({ default: { create: (...a: unknown[]) => (h.previewCreate as unknown as (...x: unknown[]) => void)(...a), release: vi.fn() } }))
