// ============================================================
// 3D 导演台 · 动画引擎 · 轨迹曲线与采样数学
// 抽自 Nomi trajectory/trajectoryUtils.ts（动画/K帧所需部分）
// ============================================================
import * as THREE from 'three'
import type { Scene3DTrajectory, Scene3DVector3 } from './types'
...
export function trajectorySegmentControlPosition(
  trajectory: Pick<Scene3DTrajectory, 'points' | 'closed' | 'curveControls'>,
  segmentIndex: number,
): THREE.Vector3 | null {
  const segmentCount = trajectorySegmentCount(trajectory)
...
export function buildTrajectoryCurve(
  trajectory: Pick<Scene3DTrajectory, 'points' | 'closed' | 'tension' | 'curveControls'>,
