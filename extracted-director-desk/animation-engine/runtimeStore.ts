// ============================================================
// 3D 导演台 · 动画引擎 · 运行时 store
// 抽自 Nomi trajectory/trajectoryRuntimeStore.ts（完整，剥离宿主依赖）
// ============================================================
import type { RefObject } from 'react'
import * as THREE from 'three'
import { create } from 'zustand'
import { subscribeWithSelector } from 'zustand/middleware'
import type { Scene3DTimeline, Scene3DTrajectory, Scene3DTrajectoryBinding, Scene3DTrajectoryGroup } from './types'
...
// 用户手上的对象（拖拽 / 变换进行中），直驱层每帧跳过，避免双写入者打架。
