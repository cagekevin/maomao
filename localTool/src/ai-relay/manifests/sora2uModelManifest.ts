...
export const SORA2U_MODEL_MANIFEST: import('../types.js').CatalogModel[] = [
  ...
  },
  {
    ...
    category: 'video',
    provider: 'sora2u',
    description: 'Sora2U 全模态视频模型，支持文生视频',
    videoCapability: {
  ...
  {
    id: 'seedance-2.0-character',
    name: 'Seedance 2.0 Character',
    category: 'video',
    provider: 'sora2u',
    description: 'Sora2U 角色一致性全模态视频模型',
    videoCapability: {
      maxImageReferences: 9,
      maxVideoReferences: 3,
      maxAudioReferences: 3,
  ...
  {
    id: 'seedance-2.0-character-mono',
    name: 'Seedance 2.0 Character Mono',
    category: 'video',
    provider: 'sora2u',
    description: 'Sora2U 单角色一致性全模态视频模型',
    videoCapability: {
      maxImageReferences: 9,
      maxVideoReferences: 3,
      maxAudioReferences: 3,
