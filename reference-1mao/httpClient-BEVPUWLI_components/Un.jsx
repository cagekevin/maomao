// TODO(全局, 无需 import): active, transitItems, transitResources, transitTotal, transitTotalPages, transitLoading, transitPage, setTransitPage, transitGridCols, setTransitGridCols, transitTabFilter, setTransitTabFilter, transitFilter, setTransitFilter, transitSourceFilter, setTransitSourceFilter, currentFolder, setCurrentFolder, creatingFolder, setCreatingFolder, newFolderName, setNewFolderName, localTool, showToastMessage, handleSyncLocal, handleToggleFavorite, handleClearResources, handleDeleteResource, handleSendToActiveTab, handleCopyResource, setFullscreenResource, openResourceMenu, setOpenResourceMenu, detail, u, s, g, f, p, m, l, x, encodeURIComponent, gridTemplateColumns, v, b, n, r, i, url, type, decodeURIComponent, method, k, left, transform, confirm, o
import _cmp_Vn from "./Vn.jsx";
import _cmp_Bn from "./Bn.jsx";
import { t, e, Hn, d, _, h, c, S, y, C, Mn, w, P, I, j, O, L, D, N, id, M, Fn, T, a, E, _Component2, Pt, _Component3, _Component4, F, Me, _Component5, Te, At, Pe, _Component6, _Component7, W, Bt, A } from "./shared.js";
      ...
      <Component26 className={`p-3 bg-[#0d0c0c] flex justify-between items-center gap-4`}>
        <Component16 className={`flex items-center gap-2`}>
          ...
          s(1);
            ...
            <_Component4 size={16} fill={m === `favorite` ? `currentColor` : `none`} />
          </Component15>
        </Component16>
                ...
                if (e.type === `folder`) {
                  ...
                  s(1);
                    ...
                    if (i.length > 0) {
                      ...
                      return null;
                        ...
                        <Me size={48} strokeWidth={1} className={`z-10 drop-shadow-md`} />
                  ...
                  return j({
                    ...
                    T(e);
                          ...
                          <_Component4 size={16} fill={e.isFavorite ? `currentColor` : `none`} />
                        </Component75>}
