...
import { t, c, d, a, _, y, Sc, wc, C, w, S, T, E, D } from './shared.js';
import * as _shared from './shared.js';
export default async function Tc(e, t = {}) {
  let {
    fps: n = 10,
    maxSize: r = 480,
    colors: i = 256,
  ...
  for (let e = 0; e < x; e++) {
    let t = f + e / y;
    await wc(u, Math.min(t, p));
    v.drawImage(u, 0, 0, h, g);
    let {
      data: n
    } = v.getImageData(0, 0, h, g);
    let r = Sc.quantize(n, C);
    let i = Sc.applyPalette(n, r);
    w.writeFrame(i, h, g, {
      palette: r,
      delay: S
    });
