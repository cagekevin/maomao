...
import { $, e, hf, t, c, a } from './shared.js';
...
export default function Lm({
  ...
  if (!n || !i || !c) {
    ...
    const Component2096 = `group`;
    return <Q.Fragment>
        <Component2096 ref={o} position={c.position} rotation={c.rotation} scale={c.scale} />
        <_cmp__Component76 mode={r} object={o} onObjectChange={l} translationSnap={r === `translate` ? a : null} />
      </Q.Fragment>;
  }
}