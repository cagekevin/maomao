...
import { e, r, D, _Component, _Component2, _Component3, R } from './shared.js';
var Rt = ({
  toasts: e,
  onRemove: t
}) => {
  let n = e => {
    switch (e) {
      case `success`:
        {
          return <D size={20} className={`text-green-300`} />;
        }
      case `error`:
        {
          return <_Component size={20} className={`text-red-300`} />;
        }
      case `warning`:
        {
          return <_Component2 size={20} className={`text-yellow-300`} />;
        }
      case `info`:
        {
          return <_Component3 size={20} className={`text-blue-300`} />;
        }
    }
  };
  let r = e => {
