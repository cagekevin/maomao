...
import { M as re, Q as d, X as f, a as ie, c as ae, d as oe, dt as p, ht as se, l as m, n as h, u as ce } from "./httpClient-BEVPUWLI.js";
var g = e(c(), 1),
  _ = n(),
  v = {
    builtin: `default`,
...
function S({
  ...
  let u = (0, g.useMemo)(() => `workflow-app-license-${e.appId}`, [e.appId]),
    ...
    Q = (0, g.useCallback)(async t => {
      ...
      try {
        ...
        k(o), j(a.mappingSchema?.fields || []), N(Object.fromEntries(o.map(e => [e.id, e.defaultValue ?? ``]))), await f.setObject(d(X), fe(a.workflowSnapshot || {
          nodes: [],
          edges: []
  ...
  let Ne = (0, g.useCallback)(async () => {
      ...
      Ae(!0), J(``);
      try {
        let n = await ie(`/workflow-apps/${encodeURIComponent(e.appId)}/verify-license`, {
          licenseToken: t
        });
    ...
    Pe = (0, g.useCallback)(() => {
      ...
      B([]), H([]), R(!0), window.dispatchEvent(new CustomEvent(ae, {
        detail: {
          targetProjectId: X
        }
      })), window.setTimeout(() => {
