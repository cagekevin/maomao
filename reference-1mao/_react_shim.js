...
// 本产物(1.5.3) export 的 Rr 是 React 工厂函数，调用后才得到完整 React 主对象(含全部 hooks/API)
const React = __e(__Rr(), 1);
if (typeof React.useState !== 'function' || typeof React.createElement !== 'function') {
  throw new Error('[react-shim] 单实例失败: Rr() 不是有效 React 对象');
}
