...
| - | ---- | ---------------------- | ---- | ---- |
| 01 | 生成链路（主链路：节点→任务中心→回填） | `components/base/api/generate.ts` · `hooks/useNodeGeneration.ts` · `scriptbox/scriptBoxEngine.ts` | **已还清（剩持平待裁定）**（2026-09-12：7 债 TD-01-1…7；**TD-01-1/2/3/4 已还**——删「再来一次」入口 · relay 失败语义 fail-loud · 剧本盒落盘失败留痕 · DATAFLOW 更正；余 TD-01-5/6/7 持平待裁定） | [01-生成链路-2026-09-12.md](01-生成链路-2026-09-12.md) |
| 02 | 存储 / 持久化 | `components/base/core/contentStore.ts` | **已验证(有债待还)**（六轮 2026-09-12：TD-02-3/4/5/6/8/10 一次还清 + 当轮 TD-02-12 当轮即还；**收尾问答复查（§八）又查出 TD-02-13 中息/02-14 低息 → 已登记待还**） | [02-存储-持久化-2026-09-11.md](02-存储-持久化-2026-09-11.md) · [02-存储-持久化-二轮深扫-2026-09-12.md](02-存储-持久化-二轮深扫-2026-09-12.md) · [02-存储-持久化-三轮-就绪度与快照schema-2026-09-12.md](02-存储-持久化-三轮-就绪度与快照schema-2026-09-12.md) · [02-存储-持久化-四轮-nodeDataSchema-2026-09-12.md](02-存储-持久化-四轮-nodeDataSchema-2026-09-12.md) · [02-存储-持久化-五轮-产出声明-2026-09-12.md](02-存储-持久化-五轮-产出声明-2026-09-12.md) · [02-存储-持久化-六轮-低息清偿与普查-2026-09-12.md](02-存储-持久化-六轮-低息清偿与普查-2026-09-12.md) |
| 03 | 资产 / 素材 | `components/base/store/assetStore.ts` · `api/filesApi.ts` | 审计中（底层已审） | [03-资产-素材-2026-09-11.md](03-资产-素材-2026-09-11.md) |
| 04 | 画布 / 节点 | `canvas/NodePalette` · `canvas/nodePrefs` · `hooks/useGenerateNode.ts` | **已还清**（9 轮：编排地基 + 逐节点/逐文件 + 最底层 + 建节点收口 + 横向共性 + 六轮 TD-04-14(方案A)/TD-04-15(node.data 15 处收口+节点层闸) + 七轮 TD-04-16(node 本体字段 width/height/style 写回唯一化 patchNodeById + nodes/ 外 data 漏网补全 + 规则5 扩全 src 豁免 agent/ 加 width/height/style 字段) + 八轮 TD-04-17(edge.data 写回唯一化 useEdgeData + edge/node.selected 收口 + 规则5 扩 setEdges + 修 WRITE_CALLS 顶层误判 bug + 新增 findSelectedSpread 专门检测 {...n, selected} 样板) + 九轮 TD-04-18(group 显示名 data.name→data.label 源头收敛：建组写侧 + 加载迁移删 name)/TD-04-19(整理 useArrangeCanvas 对 group 尺寸补写 width/height 与 style 同步) 全解决） | [04-画布-节点-2026-09-11.md](04-画布-节点-2026-09-11.md) · [04-画布-节点-二轮深扫-2026-09-11.md](04-画布-节点-二轮深扫-2026-09-11.md) · [04-画布-节点-三轮底层-2026-09-11.md](04-画布-节点-三轮底层-2026-09-11.md) · [04-画布-节点-四轮建节点收口-2026-09-11.md](04-画布-节点-四轮建节点收口-2026-09-11.md) · [04-画布-节点-五轮横向共性-2026-09-11.md](04-画布-节点-五轮横向共性-2026-09-11.md) · [04-画布-节点-六轮-TD04-15深挖-2026-09-12.md](04-画布-节点-六轮-TD04-15深挖-2026-09-12.md) · [04-画布-节点-七轮-TD04-16尺寸写回-2026-09-12.md](04-画布-节点-七轮-TD04-16尺寸写回-2026-09-12.md) · [04-画布-节点-八轮-TD04-17edge写回-2026-09-12.md](04-画布-节点-八轮-TD04-17edge写回-2026-09-12.md) · [04-画布-节点-九轮-编组字段与整理写回-2026-09-12.md](04-画布-节点-九轮-编组字段与整理写回-2026-09-12.md) · [04-画布-节点-十轮-覆盖完备性自检-2026-09-12.md](04-画布-节点-十轮-覆盖完备性自检-2026-09-12.md) · [04-画布-节点-十一轮-补审三缺口-2026-09-12.md](04-画布-节点-十一轮-补审三缺口-2026-09-12.md) · [04-画布-节点-十二轮-剩余缺口补审-2026-09-12.md](04-画布-节点-十二轮-剩余缺口补审-2026-09-12.md) |
| 05 | 提示词 | `prompt/promptManager.ts` · `prompt/promptHubStore.ts` · `prompt/PromptInput.tsx` | **已还清（剩持平待裁定）**（2026-09-12：6 债 TD-05-1…6；**TD-05-2/3 已还**（删死订阅机制 · 相邻芯片落点）、**TD-05-1 部分已还**（PromptInput 类型补全；09 侧「显式/隐含 any」护栏留待）；余 TD-05-4/5/6 持平待裁定） | [05-提示词-2026-09-12.md](05-提示词-2026-09-12.md) |
| 06 | 编辑 / 查看 | `nodes/useImageHoverActions.tsx` · `editors/*` · `utils/imageCompress·imageUpscale·faceMosaic·previewUrl` | **已还清（剩持平待裁定）**（2026-09-12：9 债 TD-06-1…9；**TD-06-1/2/3/5/6/9 已还**（删死代码 · 契约统一 · crop 纯函数收敛+letterbox 修正 · 统一图片加载 · 合成结果落盘），**TD-06-4 部分已还**（ImageEditor 去显式 any；09 侧门禁留待）；余 TD-06-7/8 持平待裁定） | [06-编辑-查看-2026-09-12.md](06-编辑-查看-2026-09-12.md) |
...
| 09 | 类型诚实性（横切：假收窄/无守卫断言） | 见 `docs/类型诚实性审计-假收窄清单.md` + `contracts.ts`（护栏：`type-check` + `check:node-data --strict` + `check:strict-src`） | **已还清**（显式断言面 F1–F37 无债 + **隐式 any 面 src 侧 1435 → 0 全目录收口 2026-09-12**：18 项白名单（16 目录 + `App.tsx`/`main.tsx`）0 隐式 any，`director3d/` 最后收口 712→0，闸 `npm run check:strict-src` 永不复涨；仅余 tests 侧 1323 处 → 另立 TD-09-2「待翻新」）<br>**06 轮复核补漏（2026-09-12）**：以上「已还清」只覆盖**隐式** any——实测 src 仍有 **6 处显式 `as any`**（`ImageEditor` ×4 / `depthVideo/loader` ×2），而白名单门禁（`noImplicitAny`）对显式 any 无感、假收窄清单「`as any` 0 处」已漂移 → **@见 TD-06-4**；**已补（2026-09-12 同日）**：新门禁 **`npm run check:any`** 全 src、**零白名单**（禁 `as any`/`as never` + 未标注 `useState(null)`/`useRef(null)`，82 处已全部标注真实类型），挂 `prebuild`/`pretest`，负例探针验证 → TD-06-4 / TD-09-3 全结清 | [09-类型诚实性-2026-09-11.md](09-类型诚实性-2026-09-11.md) · [09-类型诚实性-隐式any复核-2026-09-12.md](09-类型诚实性-隐式any复核-2026-09-12.md) |
| 10 | 云同步（Cloud） | `components/base/store/cloudSync.ts` | 已还清 | [10-云同步-2026-09-11.md](./10-云同步-2026-09-11.md) |
| 11 | AI 助手（含表格）🆕自主新增 | `agent/conversation/conversationStore.ts` · `agent/runtime/useAgentChat.ts` · `agent/canvas/useCanvasAgentTools.ts` · `panels/AgentPanel.tsx` | 已验证(无债)（12 轮 12 债全还清；工具层 + 表格域模型层 + 表格 UI 组件层 + 会话状态层中央 store 盲区均已审完） | [11-AI助手-2026-09-11.md](./11-AI助手-2026-09-11.md) |
